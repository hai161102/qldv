...
namespace QuanLiDoanVienTruongDHDN
{
    public partial class DanhSachBoSung : Form
    {
        ...
        public DanhSachBoSung()
        {
            init();
            InitializeComponent();
            //dgDoanvien.Location = new Point(12, this.addButton.Height + this.addButton.Location.Y + 50);
            //dgDoanvien.Height = this.Height - this.addButton.Height - this.addButton.Location.Y - 50;
            //dgDoanvien.Width = this.Width - 24;
        }
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            if (currentDVClicked != null)
            {
                if (
                    ...
                    doanvienDAO.delete(currentDVClicked.MaDV1, "XepLoai") &&
                    doanvienDAO.delete(currentDVClicked.MaDV1, "TTKhoaHoc") &&
